        ...
        >
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Join the WalkIn crew and get exclusive access to drops.
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                I agree to the <a href="#" className="font-bold text-blue-600">Terms</a> and <a href="#" className="font-bold text-blue-600">Privacy Policy</a>
              </label>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500 uppercase tracking-widest text-[10px] font-bold">Or sign up with</span>
              </div>
            </div>
